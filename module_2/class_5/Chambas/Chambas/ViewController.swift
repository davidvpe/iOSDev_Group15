...
//        
//        let imagen = UIImage(named: "amazon")
//        empresa1.imagen = UIImagePNGRepresentation(imagen!)
...
//        empresa1.localizacion.append(localizacion4)
        ...
        //Comentar despues de la primera prueba
//        DataManager.shared.addEmpresa(empresa: empresa1)
//        DataManager.shared.addEmpresa(empresa: empresa1)
//        DataManager.shared.addEmpresa(empresa: empresa1)
    ...
    override func viewWillAppear(_ animated: Bool) {
        arrayEmpresas = DataManager.shared.listEmpresas()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Convertir la imagen (que es de tipo Data) a un UIImage
        
        let imagenDeData = UIImage(data: empresa.imagen)
        
        cell.imgEmpresa.image = imagenDeData
    ...
    @IBAction func agregarEmpresa(segue: UIStoryboardSegue){
        ...
        //Agregamos empresa a la BD
        DataManager.shared.addEmpresa(empresa: empresaCreada)
